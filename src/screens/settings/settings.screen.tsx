  ...
  return (
    <SettingsContainer>
      ...
      <SettingsMenuItem>
        ...
        >
          <SettingsMenuItemLabel>{FOCUS_MINUTES}m</SettingsMenuItemLabel>
      ...
      <SettingsMenuItem>
        ...
        >
          <SettingsMenuItemLabel>{BREAK_MINUTES}m</SettingsMenuItemLabel>
          <Feather name="chevron-right" size={24} color="black" />
        </SettingsSelect>
      </SettingsMenuItem>
      <SettingsMenuItem>
        ...
        >
          <SettingsMenuItemLabel>{LONG_BREAK_MINUTES}m</SettingsMenuItemLabel>
          <Feather name="chevron-right" size={24} color="black" />
        </SettingsSelect>
      </SettingsMenuItem>
